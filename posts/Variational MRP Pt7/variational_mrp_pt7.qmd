...
**Note:** Since writing this post, [Pathfinder](https://mc-stan.org/docs/2_33/cmdstan-guide/pathfinder-intro.html#pathfinder-intro) has become available in CmdStan, which poses a problem for this concluding post to
the series. 
