...
calculating the determinant is roughly $\mathcal{O}(n^3)$ or a little better[^6],
...
through a bunch of base densities until one works, and can do so for much
...
implementation choices well. This isn't a free lunch- even the simple planar flow
...
[^6]: Ok fine, you probably get that down to $\mathcal{O}(n^{2.8...})$ using
