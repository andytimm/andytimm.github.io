...
sampling to approximate distributions <span style="color:red;">$\mathcal{T}(\mu = 0,\sigma = 1,t =5$)</span> and <span style="color:blue;">$\mathcal{C}(x_0= 0,\gamma = 10)$</span> with a <span style="color:green;">$\mathcal{N}(\mu = 0,\sigma = 1$)</span>. 
