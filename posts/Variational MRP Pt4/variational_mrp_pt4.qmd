...
$k \in (.5,1)$. What about actually practical to work with variance? This is the
...
satisfy $log(S) \geq \mathbb{E}_{\theta ~ q(x)}[r(\theta)log(\theta)]$ to
get accuracy. 
...
While we of course $r$ isn't Pareto exactly exactly, hopefully this helps with intuition
