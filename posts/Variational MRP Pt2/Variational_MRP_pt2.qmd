...
can approximately mirror the point estimates of MCMC, but things fall apart
as we attempt to consider uncertainty, either through simple credible intervals,
or especially once we start to visualize the unrealistic, lump posterior
...
final draws. If I had to guess, we need a fundamentally more 
