...
The slides and reproduction materials can be found here: [https://github.com/andytimm/Regularized-Raking](https://github.com/andytimm/Regularized-Raking). It looks like the presentation on stream froze for a in the middle part of the talk,
