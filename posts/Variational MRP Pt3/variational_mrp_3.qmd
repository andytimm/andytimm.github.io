...
1. What we know about Importance Weighted Variational Inference
2. Better importance sampling with built in diagnostics via PSIS
3. Combining multiple proposal distributions via Multiple Important Sampling


## Importance Weighted Variational Inference

## Diagnostics for IWVI via Pareto-Smoothed Importance Sampling
