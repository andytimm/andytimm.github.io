...
before bells and whistles like covariates or multilevel components are introduced. This has some deep problems though; let's start with the psychological ones.

First, let's talk about **symmetry**. With the likelihoods above, we're treating
the worst as sort of equal and opposite to the best. For example, though, I don't like
Joe Biden as much as I detest Trump[^5]. I really really like the best pizza
in Brookyln, but New York pizza is all New York pizza, it only gets so bad.
...
and incompetent by being solid and stablizing.