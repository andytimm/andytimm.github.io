...
involved.
Second, the Efron approximation I'll introduce in a moment has a nice representation as
an approximation of the permutations.
...
By summing over the possible


## Evaluating ROL with Unknown Middle Preferences against MaxDiff and ROL

Let's re-use our original simulation study structure here. the logic below
