...
I'm a little hesitant to call what I do in this section a true [Steelman](https://en.wikipedia.org/wiki/Straw_man#Steelmanning)
of MaxDiff, in the sense that I struggle to find the best arguments I know of
for MaxDiff compelling. Still, there's value in trying to lay out a clear 

## What if the errors are actually symmetric?

## What if MaxDiff looks the same as other models on my data?

## The advantages of the Sawtooth suite of products
