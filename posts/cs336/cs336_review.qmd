...
- **Implement DDP:** Going beyond training/finetuning/RLing relatively small models requires intelligently using multiple GPUs. DDP[^4] definitely isn't the height of this paradigm, but implementing it from scratch makes you really feel and develop intuition for the communications challenges inherent in this type of scale up.
