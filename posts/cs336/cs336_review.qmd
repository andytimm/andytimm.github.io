...
**Assignment 4:** This is more minor than the other two, but the Leaderboard section of this assignment (towards the end) provides some initial Common Crawl WET files to start from to in-course students. While you can look at various details of [Paloma](https://t.co/t2c40gjLNU) to get some reasonable thoughts on where to start, this complication added bonus steps, and it's harder to fairly compete on this leaderboard than the other two.
...
- Adding in a bunch of the slight tweaks to GRPO that have come out since the course, that are present in recent public models like [Olmo 3](https://allenai.org/blog/olmo3) or [GLM 4.7](https://huggingface.co/zai-org/GLM-4.7).
