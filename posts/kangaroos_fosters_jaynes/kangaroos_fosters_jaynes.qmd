...
only reports statistical test results, 68% of red kangaroos are left-handed, and 
80% of eastern grey kangaroos are[^13]. Perhaps Gull was observing his kangaroos
in the eastern part of Australia, which (unsurprisingly) is where eastern
grey kangaroos can be found.

As much as we stand on the shoulders of giants when it comes to Bayesian inference
