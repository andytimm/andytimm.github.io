...
3.  **How Media Shapes Politics:** How do Social Media and TV as platforms shape US Politics? How harmful are they to society in terms of polarization, if at all?[^3].
:::

::: {.column width="50%"}
# Work Projects

1.  **Strategy Given Causal Uncertainty:** Media planning decision makers' need for analytical guidance constantly outstrips their ability to generate deeply-grounded causal knowledge. Given we will never have all the causal information we desire, how do we provide actionable guidance that proves out its value when acted upon?[^4].
